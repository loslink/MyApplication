...
public class LayoutZiDingYi extends RelativeLayout { 
...
public LayoutZiDingYi(Context context) { 
this(context, null); 
} 

public LayoutZiDingYi(Context context, AttributeSet attrs) { 
this(context, attrs, 0); 
} 

public LayoutZiDingYi(Context context, AttributeSet attrs, int defStyle) { 
