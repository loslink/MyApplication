	...
	private void setListener() {
		...
		tv_change.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				intent.setClass(ActivityRegister.this, ActivityMasterRegister.class);
		...
		group.setOnCheckedChangeListener(new OnCheckedChangeListener() {
			...
			public void onCheckedChanged(RadioGroup arg0, int arg1) {
				...
				RadioButton rb = (RadioButton) ActivityRegister.this
						.findViewById(radioButtonId);
				Toast.makeText(ActivityRegister.this, rb.getText(),
		...
		bt_register.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (etp1.equals(etp2) && !etp1.equals("") && !etp2.equals("")
					...
					Toast.makeText(ActivityRegister.this, "请填完整信息！",
							Toast.LENGTH_SHORT).show();
				}
	...
	public void dialogShow() {
		...
		dialog.setPositiveButton("确定", new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				Toast.makeText(ActivityRegister.this, "注册...", Toast.LENGTH_SHORT)
						.show();
		...
		readtaskListHandler = new RequestStringHandler(context) {
			...
			public void handleString(String response) throws Exception {
				...
				if (isRegister) {
					...
					progressDialog.cancel();
					Toast.makeText(ActivityRegister.this, "注册失败！",
							Toast.LENGTH_SHORT).show();
				}
		...
		if (resultCode != RESULT_CANCELED) {
			...
			case CAMERA_REQUEST_CODE:
				if (Tools.hasSdcard()) {
					...
					Toast.makeText(ActivityRegister.this, "未找到存储卡，无法存储照片！",
